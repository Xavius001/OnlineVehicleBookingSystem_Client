...
public class TestAdminController {
    ...
    void testApproveRequestPage2() throws Exception {
        ...
        Vehicledb v1 = new Vehicledb("vehicle1", "toyota", "blue", 5, 20000, B, 10, "approved",0);
        list.add(v1);
    ...
    void testAddNewVehicle2WithError() throws Exception {
        when(cAdmin.getByVehicleId(any())).thenReturn(new Vehicledb("vehicle1", "toyota", "blue", 5, 20000, B, 10, "approved", 0));
        this.mockMvc.perform(get("/OnlineVehicleBookingSystem/AddNewVehicle/Added")
        .flashAttr("vehicledb", new Vehicledb("vehicle1", "toyota", "blue", 5, 20000, B, 10, "approved", 0)))
                .andExpect(status().isOk())
                .andExpect(model().attributeExists("msg"))
